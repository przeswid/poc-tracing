...
class TracedByTuiTracingLibraryControllerTest {
    ...
    void okTracingCheck() throws Exception {
        mvc.perform(MockMvcRequestBuilders.get("/tui/ok").accept(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk());
    }

    @Test
    void errorTracingCheck() throws Exception {
        Assertions.assertThatThrownBy(() -> mvc.perform(MockMvcRequestBuilders.get("/tui/error").accept(MediaType.APPLICATION_JSON))
